...
```{r}
motorola_datos <- read.csv("C:/Users/diego/Documents/FJ-21/1 Laboratorio de diseño y optimización de operaciones/Proyecto/Datos_Limpios.csv")
...
```{r}
write.csv(datos_completos, "C:/Users/diego/Documents/FJ-21/1 Laboratorio de diseño y optimización de operaciones/Proyecto/Datos_Completos.csv", row.names=FALSE)
```
